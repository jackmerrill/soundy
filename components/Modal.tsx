...
import { CheckIcon, ViewGridAddIcon } from "@heroicons/react/outline";
              ...
              <Dialog.Panel className="relative px-4 pt-5 pb-4 overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:max-w-sm sm:w-full sm:p-6">
                <div>
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">bababooey</p>
                      <input
                        type="text"
                        value={newSound}
                ...
                <div className="mt-2 sm:mt-6">
                  <button
                    ...
                    onClick={() => {
                      // check if the sound is a youtube url
                      if (
                        newSound.match(
                          /^(?:https?:\/\/)?(?:www\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))((\w|-){11})(?:\S+)?$/
                        )
                      ) {
                        socket.emit("createSound", newSound);
